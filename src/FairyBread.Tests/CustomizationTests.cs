...
namespace FairyBread.Tests
{
    ...
    public class CustomizationTests
    {
        ...
        {
            protected override IErrorBuilder CreateErrorBuilder(IMiddlewareContext context, string argName, ValidationFailure failure) =>
                base.CreateErrorBuilder(context, argName, failure)
                .SetMessage("lol");
        }
